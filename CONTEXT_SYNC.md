...
### 📊 STATE
- HEAD `0ccd61e` · **SW `vowvet-v287-species-enum-normalize`** · **+16 commit local CHƯA push** (a8e61b7→0ccd61e; + commit save này).
...
### 💾 BACKUP
- Bundle off-machine gần nhất `vowvet-20260606-1643.bundle` = **TRƯỚC** `e01c180` → giờ **TRỄ ~6 commit** (thiếu dọn-UI-2 `e01c180` · save `89bfd82` · mobile-first `8464940`/`f47902a` · species-fix `0ccd61e` · save này). ⚠️ **CẦN tạo bundle mới** qua `0ccd61e` (+ commit CONTEXT_SYNC): `git bundle create C:\docker\backups\vowvet-<YYYYMMDD-HHMM>.bundle --all` → verify + clone-test → **kéo cloud thủ công** (repo CHƯA có remote).
